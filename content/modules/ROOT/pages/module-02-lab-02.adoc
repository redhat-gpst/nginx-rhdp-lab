...
Execute the attack by appending the string `?hfsagrs=-1+union+select+user%2Cpassword+from+users+--+` to the end of the application URL.
...
*and many more from the bash script below*
