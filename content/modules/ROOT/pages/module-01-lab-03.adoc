...
image:images/image51.png[image51]
...
Example:
+
image:images/image31.png[image31]
+
...
Example:
+
image:images/image32.png[image32]
+
...
Example:
+
image:images/image33.png[image33]
. HTTPS
+
[NOTE]
.Note
...
Example:
+
image:images/image35.png[image35]
+
...
Example:
+
image:images/image36.png[image36]
+
Arcadia application is now exposed through the NGINX Ingress Controller
...
====
+
image:images/image52.png[image52]
+
...
Example:
+
image:images/image53.png[image53]
+
...
Example:
+
image:images/image38.png[image38]
+
...
Example:
+
image:images/image39.png[image39]
+
Arcadia application is now exposed through the NGINX Ingress Controller
...
Example:
+
image:images/image42.png[image42]
+
Arcadia application is now exposed through the NGINX Ingress Controller
with mTLS!
+
...
EXTERNAL-IP): `https://EXTERNAL-IP/`
+
image:images/image43.png[image43]
+
...
Example:
+
image:images/image44.png[image44]
. The fun does not need to stop yet!
+
The NGINX product team creates several examples of using NGINX
VirtualServers, Ingress, and Configmaps, all of the examples in the
https://github.com/nginxinc/kubernetes-ingress/tree/main/examples/custom-resources[nginxinc
GitHub repository] will also work in this environment.
